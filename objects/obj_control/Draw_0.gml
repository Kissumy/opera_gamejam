...
if room == rm_pvp
{
	...
	draw_sprite_stretched(a, 0, 864,288,48,32);
	...
	draw_sprite_stretched(a, 0, 864,352,48,32);
...
else 
{
	if !global.pvp
	{
		...
		draw_set_valign(fa_top);
		draw_set_font(fnt_texto);
		draw_text(224,320, "SCORE:");
		draw_text(224,352, string(global.point));
		draw_text(608,320, "HI-SCORE:");
		draw_text(608,352, string(global.hiscore));
	}
}